...
export default function OwnerCtaSection() {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative min-h-screen sm:min-h-[85vh] flex flex-col items-center justify-center py-16 sm:py-0 overflow-hidden bg-[#1a0f0a]"
    >
      {/* Background image */}
      <Image
      ...
      >
        ...
        >
          <span className="hidden sm:inline">Continue as Owner</span>
