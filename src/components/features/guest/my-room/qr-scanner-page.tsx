...
export default function QrScannerPage() {
  ...
  // Release camera resources — called on close and on error recovery
  ...
  // Continuous rAF loop — BarcodeDetector resolves asynchronously per frame
      ...
      <div className="min-h-screen pt-24 pb-16 flex flex-col items-center justify-center px-4"
        ...
        <div className="w-full max-w-[420px] flex flex-col items-center text-center">
          ...
          <div className="relative mb-10">
            <div className="rounded-3xl p-8 flex items-center justify-center w-[280px] h-[280px]"
            ...
            {/* Camera trigger — overlaid so guest can launch scanner from within the QR area */}
            <button
              onClick={startCamera}
          ...
          <div className="w-[280px] border rounded-full py-2.5 flex items-center justify-center gap-2"
            ...
            {phase === "scanning" && (
              <div className="w-full max-w-[350px] flex flex-col items-center gap-4">
                <div className="relative w-full aspect-square rounded-2xl overflow-hidden bg-black border border-white/10">
                  ...
                  {/* Corner brackets visually guide the user to align the QR code */}
            ...
            {phase === "detected" && (
              <div className="flex flex-col items-center gap-4 text-center">
                <div className="w-16 h-16 rounded-full flex items-center justify-center"
                  style={{ background: "color-mix(in srgb, var(--state-success) 15%, black)" }}>
