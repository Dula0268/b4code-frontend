    ...
    return (
        <div className="flex-1 bg-white rounded-2xl border border-[#F0EBE7] p-6 shadow-sm flex flex-col gap-5">
            ...
            <div className="flex items-center justify-between">
                <div>
                    <h2 className="text-[18px] font-bold text-[#1A1A1A]">Revenue Trend</h2>
                    <p className="text-[13px] text-[#9E7B6A] mt-1">Gross volume over time</p>
                </div>
            ...
            <ResponsiveContainer width="100%" height={300}>
                ...
                >
                    ...
                    <Area
                        ...
                        dot={false}
                        activeDot={{ r: 6, fill: "#C05621", stroke: "#fff", strokeWidth: 2 }}
                    />
                </AreaChart>
            </ResponsiveContainer>
        </div>
