  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      <div className="flex items-center gap-2">
        <span className="text-(--brand-primary) shrink-0">{icon}</span>
        <h3 className="m-0 text-[15px] font-bold text-(--black-2)">{title}</h3>
      </div>

      {/* Permission rows card — uses PermissionToggle for each row */}
      <div className="bg-white rounded-2xl shadow-sm overflow-hidden divide-y divide-(--gray-5)">
