...
export default function UserIcon({ size = 42, className = "" }: UserIconProps) {
  return (
    ...
    >
      ...
      {/* ── Glasses ── left lens ── */}
      <div className="absolute bottom-[51%] left-[27%] w-[20%] h-[17%] rounded-full border-2 border-[#2C1A0E] bg-[rgba(200,230,255,0.3)]" />
      {/* right lens */}
      <div className="absolute bottom-[51%] right-[27%] w-[20%] h-[17%] rounded-full border-2 border-[#2C1A0E] bg-[rgba(200,230,255,0.3)]" />
      {/* bridge */}
      <div className="absolute bottom-[57%] left-1/2 -translate-x-1/2 w-[6%] h-0.5 bg-[#2C1A0E]" />
