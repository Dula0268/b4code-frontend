...
export default function OwnerLogoutModal() {
  ...
  useEffect(() => {
    ...
    window.addEventListener("trigger-owner-logout", handleLogout);
    return () => window.removeEventListener("trigger-owner-logout", handleLogout);
  }, []);
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm animate-in fade-in duration-300">
      <div className="bg-white rounded-3xl p-10 max-w-sm w-full mx-4 flex flex-col items-center text-center shadow-xl animate-in zoom-in-95 duration-300">
        ...
        <p className="text-[#78716c] mb-8 leading-relaxed">
          You have successfully logged out of the owner portal. Thank you for using our platform!
        </p>
