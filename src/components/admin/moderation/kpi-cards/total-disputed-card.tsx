...
export default function TotalDisputedCard() {
  ...
  const totalAmount = badgeCounts?.totalResolvedAmount || 0;
  
  const formattedAmount = totalAmount.toLocaleString('en-LK', { minimumFractionDigits: 2, maximumFractionDigits: 2 });
