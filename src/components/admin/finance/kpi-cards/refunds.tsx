...
export default function RefundsCard() {
  ...
  const totalRefundsFallback =
    typeof typedSummary.totalRefunds === "number"
      ? typedSummary.totalRefunds
      : undefined;
  const pendingRefundsValue =
    summary.pendingRefunds ?? totalRefundsFallback ?? 0;
