          ...
          <div className="flex flex-col items-center justify-center mb-6 -mt-8">
            ...
            >
              <div className={`w-20 h-20 rounded-full bg-white flex items-center justify-center text-[#953002] text-2xl font-bold mb-2 border-3 shadow-md overflow-hidden transition-all duration-300 ${
                ...
                <img src={displayAvatar} alt="Guest Avatar" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300" suppressHydrationWarning />
            ...
            <h2 className="text-base font-black text-[#1c1917] mb-1 truncate w-full text-center tracking-tight" suppressHydrationWarning>{guestName}</h2>
