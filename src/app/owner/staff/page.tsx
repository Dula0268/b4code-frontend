            ...
            <div className="max-w-5xl mx-auto">
                ...
                <div className="flex items-center justify-between mb-8">
                    <div>
                        <button 
                            ...
                            className="flex items-center gap-2 text-[var(--brand-primary)] font-bold text-sm mb-2 hover:underline"
                        >
                ...
                <div className="bg-white rounded-[32px] border border-neutral-200 shadow-xl overflow-hidden">
                    <div className="p-6 border-b border-neutral-100 bg-[#fcfaf9]">
                        <h2 className="text-[18px] font-bold text-[var(--brand-primary)] flex items-center gap-2">
                            <Clock size={20} /> Pending Approvals
                            {pendingStaff.length > 0 && (
                                <span className="bg-[var(--brand-primary)] text-white text-[11px] px-2 py-0.5 rounded-full ml-1">
                                    {pendingStaff.length}
                                </span>
                            )}
                        </h2>
                    ...
                    <div className="divide-y divide-neutral-100">
                        {loading ? (
                            <div className="p-20 text-center">
                                <div className="animate-spin h-8 w-8 border-4 border-[var(--brand-primary)] border-t-transparent rounded-full mx-auto mb-4" />
                            ...
                            pendingStaff.map(staff => (
                                <div key={staff.id} className="p-6 flex flex-col md:flex-row md:items-center justify-between gap-6 hover:bg-neutral-50 transition-colors">
                                    <div className="flex items-center gap-4">
                                        <div className="h-14 w-14 bg-[#f0e8e4] rounded-2xl flex items-center justify-center text-[var(--brand-primary)] font-black text-xl">
                                        ...
                                        <div>
                                            ...
                                            <div className="flex flex-col gap-1 mt-1">
                                                <p className="text-[13px] text-neutral-500 font-medium flex items-center gap-1.5">
                                                    <User size={14} className="text-[var(--brand-primary)]/60" /> {staff.email}
                                                </p>
                                                <p className="text-[13px] text-neutral-500 font-medium flex items-center gap-1.5">
                                                    <Phone size={14} className="text-[var(--brand-primary)]/60" /> {staff.phone || "Not provided"}
                                                </p>
                                            </div>
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <button 
                                            ...
                                            className="flex-1 md:flex-none h-11 px-8 rounded-xl bg-[var(--brand-primary)] text-white font-extrabold text-[13px] hover:bg-[var(--primary-hover)] transition-all flex items-center justify-center gap-2 shadow-lg shadow-[#953002]/20"
                                        >
