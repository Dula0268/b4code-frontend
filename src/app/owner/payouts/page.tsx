...
export default function PayoutsPage() {
  ...
  return (
    <>
      ...
      />
      <main className="mt-[64px] p-6 lg:p-8 flex-1 w-full flex flex-col gap-6 max-w-7xl mx-auto">
        {/* Header */}
        <div>
          ...
          {isLoading ? (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
              {Array.from({ length: 3 }).map((_, i) => (
                <div key={i} className="bg-white rounded-3xl border border-[#E8DDD8] shadow-sm overflow-hidden">
