        ...
        <div className="flex h-screen w-screen fixed top-0 left-0 bg-[#faf9f7] overflow-hidden font-sans">
            ...
            <main className="flex-1 flex flex-col min-w-0 overflow-hidden">
                ...
                <div className="flex-1 overflow-y-auto px-8 pb-10">
                    ...
                    <h1 className="text-[24px] font-black text-[#1d1d1d] m-0 mb-5">
                        Edit Restriction: <span className="font-normal">Weekend Minimum</span>
                    </h1>
                        ...
                        <div className="flex flex-col gap-4">
                            ...
                            <div className="bg-white border border-[#e8e8e8] rounded-xl p-5.5 px-6">
                                ...
                                <div className="flex justify-between items-center py-3.5">
                                    ...
                                    <div className="flex items-center gap-1.5">
                                        <input type="text" value={advanceNotice} onChange={(e) => setAdvanceNotice(e.target.value)} className="w-20 py-1.5 px-2 border border-[#e0e0e0] rounded-md text-[14px] text-[#1d1d1d] text-center outline-none font-sans font-semibold" />
                                        <div className="relative">
                        ...
                        <div className="flex flex-col gap-4">
                            ...
                            <div className="bg-white border border-[#e8e8e8] rounded-xl p-5.5 px-6">
                                <div className="flex items-center gap-1.5 mb-3">
                                    ...
                                    <span className="text-[11px] font-extrabold text-[#828282] tracking-[1.2px] uppercase">Revenue Tips</span>
                                </div>
