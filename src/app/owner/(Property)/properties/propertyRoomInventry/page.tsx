                ...
                <div className="flex-1 overflow-y-auto pb-4 pr-1">
                    ...
                    <div className="bg-white border border-[#e8e8e8] rounded-[14px] py-3.5 px-5 flex items-center justify-between mb-0">
                        ...
                        <div className="flex gap-2.5">
                            ...
                            <button className="py-2 px-5 bg-[#953002] text-white border-none rounded-lg text-[12px] font-semibold cursor-pointer">Save Changes</button>
                        </div>
                    </div>
                        ...
                        <div className="flex flex-col gap-3">
                            <div className="bg-white border border-[#e8e8e8] rounded-xl py-4 px-5">
                                <div className="flex justify-between items-center mb-3.5">
                                    ...
                                    <button className="flex items-center gap-1 py-2 px-4 bg-[#953002] text-white border-none rounded-lg text-[12px] font-semibold cursor-pointer"><Plus size={14} /> Add New Room</button>
                                </div>
