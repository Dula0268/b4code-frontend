...
// Quick reply buttons for UI convenience
...
function MessagingContent() {
    ...
    const data = isStaff ? {
        ...
        img: activeBooking.imageSrc || "/images/room/resort-exterior.png",
        status: "Staff Online",
        ...
        img: activeBooking.imageSrc || "/images/booking/sunset-peak-resort.png",
        status: "Online now",
